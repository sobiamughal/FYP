package com.example.roubaisha.calendarlibrary;
...
import com.example.roubaisha.calendarlibrary.calendar.CalendarInstance;

import static android.R.attr.resource;
import static com.example.roubaisha.calendarlibrary.MyCalendarView.Language.Arabic;
import static com.example.roubaisha.calendarlibrary.R.id.linear_header;
...
//
    ...
    public void setButtonTint(Button button) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && button instanceof AppCompatButton) {
